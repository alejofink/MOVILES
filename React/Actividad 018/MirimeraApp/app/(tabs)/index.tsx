  ...
  return (
    ...
    >
      ...
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="title">Saludo</ThemedText>
        ...
        <TouchableOpacity
          onPress={handleChangeGreeting}
          style={styles.button}
        >
          <ThemedText style={styles.buttonText}>Cambiar Saludo</ThemedText>
        </TouchableOpacity>
      </ThemedView>
