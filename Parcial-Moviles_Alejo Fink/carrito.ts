...
interface Producto {
  ...
  stock: number;           // Unidades disponibles en stock
  categoria: string;       // Categoría del producto (tecnología, ropa, etc.)
}

// Define la estructura de un ítem dentro del carrito de compras
interface ItemCarrito {
  productoId: number;      // ID del producto agregado al carrito
  nombre: string;          // Nombre del producto
...
function agregarProducto(id: number, cantidad: number): void {
...
function quitarProducto(id: number): void {
...
function modificarCantidad(id: number, nuevaCantidad: number): void {
